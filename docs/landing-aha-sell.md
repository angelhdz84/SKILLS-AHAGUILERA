...
| **Full** (incluido en Standard/Custom) | Todo lo de Lite + ingesta de PDF, DOCX, XLSX, CSV, MD. QA extractivo: hazle preguntas en español y responde citando sus propios documentos. Atajo global `Cmd+K` desde cualquier pantalla | ✅ .exe ✅ .apk |
...
## 7. Mejoras sugeridas para la landing
...
## 9. Argumentos de venta — Frases lista para WhatsApp
...
## 10. Checklist de pre-lanzamiento de cada app
