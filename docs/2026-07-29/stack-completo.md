...
| **@tailwindcss/browser** | 4 | CSS runtime (genera utilidades en browser) |
| **DaisyUI** | 5 | Componentes UI (btn, card, input, modal, drawer, tabs, table — temas via daisyui-themes.css) |
...
|----------|--------|----------------------|-----------|
| **DaisyUI 5** | Tema oscuro/claro, clases semanticas oklch | btn, card, input, modal, drawer, tabs, table, badge, skeleton, dropdown | Default |
