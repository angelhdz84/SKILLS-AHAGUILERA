# CampoApp — Registro de campo offline para agricultura y ganadería
...
| Perfil | Formato | IA |
|--------|---------|----|
| Lite | .exe | Búsqueda de registros + reportes básicos |
| Standard | .exe + .apk | + Predicción de rendimiento + alertas de insumos + fotos offline |
| Custom | .exe + .apk + código fuente | Todo + UI personalizada + reportes PDF con marca |
...
Quiero CampoApp para llevar registro de mis lotes y ganado
