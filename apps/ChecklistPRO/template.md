# ChecklistPRO — Inspecciones y checklists técnicos offline
...
| Perfil | Formato | IA |
|--------|---------|----|
| Lite | .exe | Búsqueda de plantillas + historial |
| Standard | .exe + .apk | + Predicción de áreas con más fallas + fotos offline |
| Custom | .exe + .apk + código fuente | Todo + UI con logo de la empresa |
...
para mantenimiento. Me interesa ChecklistPRO plan Standard
con .exe y .apk.
```
