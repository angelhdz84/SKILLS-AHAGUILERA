# ComandaApp — Toma de pedidos offline para restaurantes y bares
...
| Perfil | Formato | IA |
|--------|---------|----|
| Lite | .exe | Búsqueda instantánea de mesas y productos |
| Standard | .exe + .apk | + Predicción de platillos más pedidos + horarios pico |
| Custom | .exe + .apk + código fuente | Todo + UI personalizada con logo del negocio |
...
```
Hola Angel, vi la ComandaApp para mi restaurante.
